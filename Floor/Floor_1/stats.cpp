...
extern "C" {
    ...
    void generate_random_stats(int32_t* buffer) {
        ...
        std::mt19937 gen(rd()); // std::mersenne_twister_engine<unsigned int, 32Ui64, 624Ui64, 397Ui64, 31Ui64, 2567483615U, 11Ui64, 4294967295U, 7Ui64, 2636928640U, 15Ui64, 4022730752U, 18Ui64, 1812433253U> 
